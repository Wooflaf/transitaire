...
datos_diarios <- read_delim(url,delim = ";")
...
datos_diarios_clean <- pivot_longer(datos_diarios_interesantes, names_to = "Parametros", values_to = "Valores", cols = c( PM2.5, PM10,NO2, O3, SO2))
